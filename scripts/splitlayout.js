(function() {
	...
	/* Here's a function that uses an insanely long and comprehensive regex which returns a true or false value 
	 depending on whether or not the user is browsing with a mobile.*/
	...
	var splitlayout = document.getElementById( 'splitlayout' ),
		rightSide = splitlayout.querySelector( 'div.splitscreen > div.split-right' ),
	...
	function init() {
		...
		rightSide.querySelector( 'div.splitscreen-content' ).addEventListener( eventtype, function( ev ) {
			reset();
		...
		splitlayout.querySelector( 'a.back-left' ).addEventListener( eventtype, backTosplitscreen );
	}
